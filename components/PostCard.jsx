...
const PostCard = ({post}) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <div 
        className="bloc text-center items-center 
          justify-content mb-8 w-full"
      >
        <div 
          className="flex items-center justify-center mb-1 lg:mb-0 w-full
            lg:w-auto mr-8"
        >
          <img
            ...
            height='60px'
            width='60px'
            className="mx-2 align-middle rounded-full"
            src={post.author.photo.url}
          />
          <p className="inline align-middle text-gray-800  text-lg">
            {post.author.name}
          </p>
          <div className="mx-3 font-medium text-gray-700">
          <svg 
        ...
        <p 
          className="text-center text-lg text-gray-700 font-normal 
            px-4 lg:px-20 mb-8"
        >
          {post.excerpt}
        </p>
